...
class MainActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        if (SpotifyAppRemote.isSpotifyInstalled(this)){
            ...
            connectionParams = ConnectionParams.Builder(getString(R.string.client_id))
            ...
            SpotifyAppRemote.connect(this, connectionParams, object : Connector.ConnectionListener {
                ...
                override fun onConnected(spotifyAppRemote: SpotifyAppRemote?) {
                    ...
                    Log.d(TAG, "getRecommendedContentItems = " + spotifyAppRemote?.contentApi?.getRecommendedContentItems(ContentApi.ContentType.DEFAULT))
                }
            })
        ...
        playMeButton.setOnClickListener {
            ...
            mSpotifyAppRemote!!.playerApi.subscribeToPlayerState().setEventCallback { playerState: PlayerState ->
    ...
    private fun updateTrackCoverArt(playerState: PlayerState) {
        ...
        assertAppRemoteConnected()
            ...
            .setResultCallback { bitmap ->
                Log.d(TAG, "ImageURI = " +playerState.track.imageUri + " dimens = " + bitmap.width + " " + bitmap.height)
